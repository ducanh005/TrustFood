...
const styles = StyleSheet.create({
  ...
  author: { color: '#fff', fontWeight: '600', fontSize: scaleFont(15) },
  location: { color: '#FFD400', fontSize: scaleFont(12), marginTop: verticalScale(2) },
  postImage: { width: '100%', height: verticalScale(284), backgroundColor: '#222', borderRadius: moderateScale(12) },
  postFooter: { padding: moderateScale(12) },
  postText: { color: '#fff', marginBottom: verticalScale(8) },
  metaRow: { flexDirection: 'row', alignItems: 'center' },
  metaBtn: { flexDirection: 'row', alignItems: 'center', marginRight: moderateScale(18) },
  meta: { color: '#fff', fontSize: scaleFont(14) },
